...
@Controller
public class TraderOrderBook {

    private ApplicationContext ctx;

    @RequestMapping(value = "/traderOrderBook", method = RequestMethod.POST, produces = "application/json; charset=utf-8")
    @ResponseBody
    public String GetTradeHistory(@RequestBody String j)throws IOException{
	        ...
	        ctx = new ClassPathXmlApplicationContext("bean.xml");
	        	GetOrderBookImp getOrderBookImp = (GetOrderBookImp)ctx.getBean("selectTraderBook");
	        String result = getOrderBookImp.getOrderBookByTraderId(limit, offset, traderId, symbol);
