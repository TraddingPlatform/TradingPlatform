...
<link rel="canonical" href="https://teamemo.com/">
<link rel="alternate" hreflang="en" href="https://teamemo.com/">
<link rel="alternate" hreflang="de" href="https://teamemo.com/de">
...
<script id="piwikOptions" type="text/json">[
        ["setTrackerUrl", "https://piwik.teamemo.com/piwik.php"],
        ["setSiteId", "3"],
        ["setCustomVariable", 1, "LandingpageBackground", "A", "visit"],
...
<body class="">
			...
			<div class="container" data-reactid=".0.0.0">
				...
				<div class="collapse navbar-collapse" id="navcol-1"
					...
					<ul class="nav navbar-nav navbar-right" data-reactid=".0.0.0.1.0">
						<li role="presentation" data-reactid=".0.0.0.1.0.0:0"
							class="active"><a id="link_signup"
							href="https://teamemo.com/#signup"
						...
						<li role="presentation" data-reactid=".0.0.0.1.0.0:3"><a
							id="link_signin" href="https://teamemo.com/#signin"
			...
			<div class="col-md-12 phone-preview"
				...
				<div class="sign-card" id="symbol_form"
					...
					<form class="form-sign" id="symbolForm" onsubmit="return false;"
						...
						<input id="symbol" class="form-control" type="text" required=""
	...
	<footer style="margin-top: 5px;" data-reactid=".0.3">
		<div class="row" data-reactid=".0.3.0">
			...
			<div class="col-md-6 footer-about" data-reactQid=".0.3.0.3">
