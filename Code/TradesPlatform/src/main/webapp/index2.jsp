...
<body class="">
			...
			<div class="collapse navbar-collapse" id="navcol-1"
				...
				<ul class="nav navbar-nav navbar-right" data-reactid=".0.0.0.1.0">
					...
					<li role="presentation" data-reactid=".0.0.0.1.0.0:2"><a
						href="https://teamemo.com/pricing" data-reactid=".0.0.0.1.0.0:2.0"><span
					...
					<li role="presentation" data-reactid=".0.0.0.1.0.0:3"
						...
						href="https://teamemo.com/#signin" data-reactid=".0.0.0.1.0.0:3.0">Sign
							in</a></li>
	...
	<div id="jumbo-bg" class="bg"
		style="background: url(imgs/coffee.jpg) no-repeat center;"></div>
